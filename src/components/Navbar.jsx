...
export default function Navbar() {
    return (
        <div className='animate-slide-in-top fixed w-full py-4 md:py-0 top-5 left-1/2 -translate-x-1/2 flex justify-center gap-x-4 md:gap-x-10 items-center md:px-6 tracking-wide md:tracking-wider font-semibold text-white z-50 bg-white/60 backdrop-blur-md'>
